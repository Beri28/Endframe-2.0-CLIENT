...
import { Laptop, Image, Smartphone, Rocket } from 'lucide-react';
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-12">
            <div>
              ...
              <p className="text-gray-600 text-sm md:text-base">
                Create a stunning website with free templates and<br className="hidden md:block" />
            ...
            <div className="max-w-xl md:max-w-2xl mx-auto px-4">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 md:px-6 py-3 md:py-4 bg-white rounded-lg shadow-sm border border-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent pl-12 text-zinc-950"
                />
